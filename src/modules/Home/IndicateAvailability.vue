<template>
  <div class="my-8 px-3">
    ...
    <b-row class="justify-content-between mt-8">
      <b-col lg="5">
        <h2 class="font-weight-bold mb-3">Connect in your field of interest</h2>
        <p>
          Grow your personal network by connecting and following others with
